...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**create_item_items_post**](docs/DefaultApi.md#create_item_items_post) | **POST** /items/ | Create Item
*DefaultApi* | [**get_items_items_get**](docs/DefaultApi.md#get_items_items_get) | **GET** /items/ | Get Items
